...
throughput_1 = [16384*4.096/(condition_1[idx]/1000) * (idx + 1) for idx in range(len(condition_1))]
throughput_2 = [16384*4.096/(condition_2[idx]/1000) * (idx + 1) for idx in range(len(condition_2))]
...
plt.text(5.5, position_127GB*1.02, f"127 GB/s", fontsize = 8, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')
...
save_plot('./section3', 'plot1_throughput_node_line_full')
