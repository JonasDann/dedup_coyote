...
condition_1 = [23988.0, 24032.8, 7774.75, 7982.25, 7158.5]
condition_2 = [25398.0, 25533.5, 9952.0, 9785.25, 8864.5]

throughput_1 = [(a/1000) for a in condition_1]
throughput_2 = [(a/1000) for a in condition_2]
# Number of cases
n_cases = len(cases)
...
save_plot('./plot2', 'latency_workload_bar')
