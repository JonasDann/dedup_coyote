...
condition_1 = [5288480.0, 5285320.0, 2991200.0, 3060070.0, 2759910.0]
condition_2 = [5287290.0, 5358210.0, 4310450.0, 4382740.0, 4072770.0]
...
# plt.text(0.5, position_12GB7*1.02, f"12.7 GB/s", fontsize = 7, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')
...
save_plot('./plot1_1', 'throughput_workload_bar')
