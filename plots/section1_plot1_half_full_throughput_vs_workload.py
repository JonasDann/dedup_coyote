...
print(f'{improvement=}') 
# SHA2 improvement=[3.616861555683297, 3.6222657772362834, 3.9332812393573144, 1.8943977333511635, 1.8098164421075333, 1.1881728027363212]
# SHA3 improvement=[4.044508062808218, 4.026988448251725, 4.185697365533213, 1.8943977333511635, 1.8098164421075333, 1.1881728027363212]
# Number of cases
n_cases = len(cases)
...
plt.text(1.2, position_12GB7*1.02, f"12.7 GB/s", fontsize = 7, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')

# line for 3.5
position_3GB5 = (3.1/4.096)
plt.axhline(y = position_3GB5, color = 'r', linestyle = 'dashed', linewidth = 0.5, zorder = 5)
plt.text(0.77, position_3GB5*1.02, f"3.1 GB/s", fontsize = 7, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')
...
save_plot('./section1', 'plot1_throughput_workload_bar_half_full')
