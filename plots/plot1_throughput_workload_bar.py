...
# Placeholder data
cases = ['Write only\n all dup', 'Write only\n half dup', 'Write only\n no dup', 'Erase only\n all GC', 'Erase only\n no GC', 'Read only']
conditions = ['hash table half full', 'hash table full']
condition_1 = [5288480.0, 5285780.0, 5285320.0, 2991200.0, 3060070.0, 2759910.0]
condition_2 = [5287290.0, 5286860.0, 5358210.0, 4310450.0, 4382740.0, 4072770.0]

throughput_1 = [16384/(a/1000) for a in condition_1]
throughput_2 = [16384/(a/1000) for a in condition_2]
# Number of cases
n_cases = len(cases)
...
save_plot('./plot1', 'throughput_workload_bar')
