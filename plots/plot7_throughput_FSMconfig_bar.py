...
# Placeholder data
cases = ['Write only\n all dup', 'Write only\n half dup', 'Write only\n no dup']
conditions = ['6 FSM w/o BF', '6 FSM w/ BF', '8 FSM w/o BF']
condition_1 = [
5287080.0,
5395000.0,
6312500.0,
...
bar1 = ax.bar(index - (bar_dist + bar_width), throughput_1, bar_width, label=conditions[0])
bar2 = ax.bar(index, throughput_2, bar_width, label=conditions[1])
bar3 = ax.bar(index + (bar_dist + bar_width), throughput_3, bar_width, label=conditions[2])

for idx in range(len(throughput_1)):
  print(throughput_1[idx], throughput_2[idx], throughput_3[idx])

# line for 12.7
# position_12GB7 = 12.7
# plt.axhline(y = position_12GB7, color = 'r', linestyle = 'dashed', linewidth = 0.5, zorder = 5)
# plt.text(1, position_12GB7*1.01, f"12.7 GB/s", fontsize = 7, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')

# text for 12.52
# position_12GB5 = 12.5
# plt.text(2, position_12GB7, f"12.5 GB/s", fontsize = 7, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')

# # text for 12.44
# position_12GB4 = 12.4
# plt.text(1 - (bar_dist + bar_width), position_12GB4, f"12.4 GB/s", fontsize = 7, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')

# # text for 10.63
# position_10GB6 = 10.6
# plt.text(2 - (bar_dist + bar_width), position_10GB6, f"10.6 GB/s", fontsize = 7, rotation=0, rotation_mode='anchor', weight = 'bold', ha = 'center', va = 'bottom')
...
save_plot('./plot7', 'throughput_FSMconfig_bar')
