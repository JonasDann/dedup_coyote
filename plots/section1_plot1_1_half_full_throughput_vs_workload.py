...
# baseline_half_full = [1.91277e+07, 2.078865e+07, 5.6665225e+06 ,5.538165e+06, 3.27925e+06]
# baseline_full = [1.957e+07,1.5509775e+10, 9.6264575e+06, 7.38419e+06, 5.4514425e+06]

# SHA3-256
# insertion: 64 thread, slightly faster than 32/128 thread
# ./main -n 16384 -d 0 -f 0.99 -h 64
# ./main -n 16384 -g 0 -f 0.5 -o 2
baseline_half_full = [2.13893e+07, 2.212275e+07, 5.6665225e+06 ,5.538165e+06, 3.27925e+06]
baseline_full = [2.1628575e+07, 1.5430925e+10, 9.6264575e+06, 7.38419e+06, 5.4514425e+06]

stream_dedup_half_full = [5288480.0, 5285320.0, 2991200.0, 3060070.0, 2759910.0]
stream_dedup_full = [5287290.0, 5358210.0, 4310450.0, 4382740.0, 4072770.0]

throughput_1 = [16384/(a/1000) for a in baseline_half_full]
throughput_2 = [16384/(a/1000) for a in stream_dedup_half_full]
improvement = [b/a for a, b in zip(throughput_1, throughput_2)]
print(f'{improvement=}') 
# SHA2 improvement=[3.616861555683297, 3.9332812393573144, 1.8943977333511635, 1.8098164421075333, 1.1881728027363212]
# SHA3 improvement=[4.044508062808218, 4.185697365533213, 1.8943977333511635, 1.8098164421075333, 1.1881728027363212]
# Number of cases
n_cases = len(cases)
...
save_plot('./section1', 'plot1_1_throughput_workload_bar_half_full')
